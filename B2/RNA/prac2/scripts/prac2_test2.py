...
class SimpleCNN(nn.Module):
    ...
    def forward(self, x):
        ...
        x = torch.flatten(x, start_dim=1) # si start_dim = 0 se aplana completamente a 1 dimension,
        # como start_dim = 1 se aplana a 1 dimension pero manteniendo la dimension de batch
